      ...
      return (
        <div className="min-h-dvh flex flex-col items-center justify-center p-8 text-center" style={{ backgroundColor: 'oklch(17% 0.009 56)' }}>
          <div className="glass-card p-10 max-w-sm">
            ...
            <h2 className="text-[17px] font-serif font-semibold text-amber tracking-[0.04em] mb-2">出了点问题</h2>
            <p className="text-[13px] text-dusk-100/60 mb-6 leading-relaxed">{this.state.error?.message}</p>
            <button
              onClick={() => {
