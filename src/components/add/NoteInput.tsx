  ...
  return (
    <div className="page-mx">
      ...
      <div className="flex items-center justify-between mt-2.5">
        <p className="text-[11px] text-dusk-100/45 italic tracking-[0.04em] font-serif">说点什么吧</p>
        <p className={`text-[11px] font-medium tabular-nums font-mono tracking-[0.04em] ${value.length > 400 ? 'text-amber' : 'text-dusk-100/45'}`}>
          {value.length}/500
        </p>
      </div>
    </div>
