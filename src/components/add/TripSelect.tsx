            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <span className="font-serif font-semibold text-[15px] text-dusk-50 truncate tracking-[0.04em]">
                    {trip.title}
                  </span>
                </div>
      ...
      {showNew ? (
        <div className="p-5 glass-card animate-scale-in relative">
          ...
          <div className="grid grid-cols-1 gap-2.5 mt-2.5 sm:grid-cols-2">
            <div className="flex-1">
              <label
                htmlFor="new-trip-start"
                className="block text-[11px] font-medium text-dusk-100/65 mb-1.5 tracking-[0.04em]"
              >
                开始
              </label>
              <input
          ...
          {dateError && (
            <p role="alert" className="mt-2 text-[11px] text-red-300/80">
              {dateError}
            </p>
          )}
