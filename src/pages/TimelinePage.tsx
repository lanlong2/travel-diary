...
import { groupRecordsByMonth } from '../data/selectors'
...
export function TimelinePage() {
  ...
  const groupedByMonth = useMemo(() => groupRecordsByMonth(photos), [photos])
      ...
      {photos.length === 0 ? (
        <div className="reading-column page-px relative mt-8 mb-8 py-10">
          <div
            ...
            style={{
              background:
                'linear-gradient(180deg, transparent, oklch(58% 0.13 40 / 0.2), transparent)',
            }}
            aria-hidden="true"
          />
